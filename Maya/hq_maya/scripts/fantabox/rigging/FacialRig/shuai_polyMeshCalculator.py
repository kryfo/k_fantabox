...
def shuai_polyMeshCalculator():
	...
	mc.columnLayout()
	mc.optionMenu('calculateModeControl' ,label='                             计算模式：',cc='fb.rig.FacialRig.optionChangeCmd()')
	...
	mc.textFieldButtonGrp('inputMeshControl1',l='最终模型：',bl='Get',bc='fb.rig.FacialRig.getButtonCmd(\'inputMeshControl1\')')
	mc.textFieldButtonGrp('inputMeshControl2',l='蒙皮模型：',bl='Get',bc='fb.rig.FacialRig.getButtonCmd(\'inputMeshControl2\')')
	mc.textFieldButtonGrp('ouputMeshControl',l='输出模型：',bl='Get',bc='fb.rig.FacialRig.getButtonCmd(\'ouputMeshControl\')')
	mc.button('calculate',l='运算',h=30,w=500,c='fb.rig.FacialRig.CalculateButtonCmd()')
